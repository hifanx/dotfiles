...
local hl = {
    ...
    DiffDelete = { bg = c.red_diff },
    DiffText = { fg = c.orange, bold = true },
    DiffTextAdd = { fg = c.green, bold = true },
    TermCursor = { link = 'Cursor' },
    OkMsg = { fg = c.green },
    WarningMsg = { fg = c.yellow },
    ErrorMsg = { fg = c.red },
    StderrMsg = { link = 'ErrorMsg' },
    StdoutMsg = { fg = c.fg_60 },
    ...
    Statement = { fg = c.fg_60, bold = true },
    Operator = { fg = c.fg_40 },
    ...
    ['@keyword.import'] = { fg = c.red, bold = true, italic = true },
