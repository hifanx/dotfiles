// Treesitter demo: directives, comments, chars, numbers, ternary
// Demonstrates: @comment.*, @keyword.directive, @keyword.directive.define,
// @character, @character.special, @number, @number.float, @boolean,
// @keyword.repeat, @keyword.conditional, @keyword.return,
// @punctuation.delimiter, @punctuation.bracket, @punctuation.special.

// TODO: demonstrate todo comment keyword -> @comment.todo
// NOTE: important note comment -> @comment.note
// WARNING: be careful here -> @comment.warning
// ERROR: something went wrong -> @comment.error
// Simple line comment -> @comment

/*
 * Multi-line documentation comment -> @comment.documentation
 */
