...
const vec4 TRAIL_COLOR = vec4(242.0/255.0, 205.0/255.0, 205.0/255.0, 1.0); // #F2CDCD (soft pink)
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.976, 0.863, 0.863, 1.0); // Brighter variant of #F2CDCD
const vec4 ELECTRIC_COLOR = vec4(0.95, 0.85, 0.90, 1.0); // Pink-tinted electric color
